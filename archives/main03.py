...
class MenuImport:
    ...
    def afficher_menu(self):
        ...
        print("6. Agrégation par catégorie")
        print("7. Agrégation par sous-catégorie")
        print("0. Quitter")
        print("-"*64)
    ...
    def menu_agregation(self):
        """Fonction pour l'agrégation par catégorie"""
        if not self.operations:
            print("\n⚠️ Aucune opération en mémoire")
        else:
            afficher_agregation(self.operations)
        input("\nAppuyez sur Entrée pour continuer...")

    def menu_agregation_sous_categorie(self):
        """Nouvelle fonction pour l'agrégation par sous-catégorie"""
        if not self.operations:
            print("\n⚠️ Aucune opération en mémoire")
        else:
            afficher_agregation_sous_categorie(self.operations)
        input("\nAppuyez sur Entrée pour continuer...")
    ...
    def executer(self):
        while True:
            ...
            if choix == "1":
                ...
                self.menu_agregation_sous_categorie()
            elif choix == "0":
                print("\n👋 Au revoir!"); break
            else:
